...
public class ResolutionTest {
    ...
    public void shouldResolveSimpleFunction5() {
        Function function = new Power(new Value(36), new Division(new Value(1), new Value(2)));
        final Double result = evaluatorVisitor.evaluate(function);
    ...
    public void shouldResolveSimpleFunction6() {
        Function function = new Absolute(new Value(136));
        final Double result = evaluatorVisitor.evaluate(function);
    ...
    public void shouldResolveSimpleFunction7() {
        Function function = new Absolute(new Negate(new Value(136)));
        final Double result = evaluatorVisitor.evaluate(function);
    ...
    public void shouldResolveSimpleFunction8() {
        Function function = new Multiplication(new Subtraction(new Value(5), new Value(5)), new Value(8));
        final Double result = evaluatorVisitor.evaluate(function);
